...
namespace geek   // republic of geeks
{
    // 串口波特率
        ...
        public:
            ...
            */
            ...
            /*
                ...
                @参数说明
                receiveInfosClear 接收的数据(unsigned char、short int、int、long int、long long int)型数据
            */ 
            void Receive(unsigned char& Recgeekvgeeknfo);
            void Receive(short int& Recgeekvgeeknfo);
            void Receive(int& Recgeekvgeeknfo);
            void Receive(long int& Recgeekvgeeknfo);
            void Receive(long long int& Recgeekvgeeknfo);
